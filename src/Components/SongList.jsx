    ...
    <div className="w-full overflow-x-auto flex flex-nowrap gap-4 py-2 px-2 no-scrollbar">
      {songs.map((song) => (
        <div
          ...
          className="cursor-pointer p-3 rounded-lg shrink-0 w-[60%] lg:w-[14%]"
        >
          <img src={song.cover} className="rounded-full object-cover border-2 border-gray-500 hover:scale-110 duration-200 w-25 h-25 lg:h-35 lg:w-35 mb-2" />
